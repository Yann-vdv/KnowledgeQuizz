        ...
        <div class="col-5 bg-white border rounded-5 shadow py-5 px-7">
            <div class="d-flex flex-column mx-7">
                ...
                <form class="d-flex flex-column" action="" method="post">
                    ...
                    <input type="submit" class="my-3 btn btn-outline-danger fs-5 fw-bold" value="Se connecter"></input>
                    <div class="d-flex my-3"><p class="mb-0 me-1">Vous n'avez pas de compte ?</p><a class="text-decoration-none" href="inscription.php">Inscrivez-vous</a></div>
                </form>
            </div>
        </div>
        <div class="col-1"></div>
